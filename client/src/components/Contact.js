            ...
            <table className = "contact-table">
                    <tbody>
                        <tr>
                            ...
                            <td><div><img className="contactIMGLinkedin" src={Linkedin} alt="Linkedin" /><br></br><a href="https://www.linkedin.com/in/eyal-blumental-erez-b6ba4627b" rel="noopener noreferrer" target="_blank">Linkedin</a></div></td>
                        </tr>
                    </tbody>
                </table>
